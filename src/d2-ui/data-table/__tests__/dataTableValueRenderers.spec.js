        ...
        userSettings: {
            get: async key => {
                if (key === 'keyUiLocale') {
                    ...
                    throw new Error(`Unknown user settings key: '${key}'`)
                }
            }
        }
    }
...
const shallowRenderWithD2 = component => shallow(component, {
    context: {
        d2: stubD2
    }
});
...
describe('dataTableValueRenderers', () => {
    describe('publicAccess', () => {
        it('should find the correct renderer', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="r-------" />);
        ...
        it('should render the r-r----- publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="r-r-----" />);
        ...
        it('should render the r-rw---- publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="r-rw----" />);
        ...
        it('should render the rw------ publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="rw------" />);
        ...
        it('should render the rwr----- publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="rwr-----" />);
        ...
        it('should render the rwrw---- publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="rwrw----" />);
        ...
        it('should render the -------- publicAccess pattern to its correct text value', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="--------" />);
        ...
        it('should not transform an unknown publicAccess pattern', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<PublicAccessRenderer value="rwx-----" />);
    ...
    describe('DATE valueType', () => {
        ...
        it('should find the correct renderer', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<DateValueRenderer value="2016-02-18T11:21:32.992" />, renderOptions);
        ...
        it('should render nothing when there is no date', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<DateValueRenderer />, renderOptions);
    ...
    describe('objects with displayName', () => {
        it('should find the correct renderer', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<ObjectWithDisplayNameRenderer value={{ displayName: 'ANC' }} />);
        ...
        it('should fall back to the name property when the displayName does not exist', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<ObjectWithDisplayNameRenderer value={{ name: 'ANC' }} />);
        ...
        it('should not throw when the value is undefined and render an empty span', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<ObjectWithDisplayNameRenderer value={undefined} />);
    ...
    describe('color values', () => {
        ...
        it('should render the value as the text of the Color component', () => {
            const ColorRenderer = findValueRenderer({ value: '#FFFDDD', columnName: 'color' });
            const renderedComponent = shallowRenderWithD2(<ColorRenderer value="#FFFDDD" />);
        ...
        it('should render a light text color for a light color', () => {
            ...
            const renderedComponent = shallowRenderWithD2(<ColorRenderer value="#222222" />);
