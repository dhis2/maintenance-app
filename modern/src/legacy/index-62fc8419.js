import { bg as commonjsGlobal, r as react, G as propTypes } from './index-44839b1a.js';
...
var _baseGetTag$1 = baseGetTag$c;
...
var isObjectLike_1$1 = isObjectLike$e;
...
function isString(value) {
  return typeof value == 'string' ||
    (!isArray$d(value) && isObjectLike$d(value) && baseGetTag$b(value) == stringTag$5);
}
...
function baseIsArguments$3(value) {
  return isObjectLike$c(value) && baseGetTag$a(value) == argsTag$5;
}
...
var isArguments$4 = baseIsArguments$2(function() { return arguments; }()) ? baseIsArguments$2 : function(value) {
  return isObjectLike$b(value) && hasOwnProperty$f.call(value, 'callee') &&
...
typedArrayTags$1[mapTag$6] = typedArrayTags$1[numberTag$4] =
typedArrayTags$1[objectTag$5] = typedArrayTags$1[regexpTag$4] =
typedArrayTags$1[setTag$6] = typedArrayTags$1[stringTag$4] =
...
function baseIsTypedArray$3(value) {
  return isObjectLike$a(value) &&
    isLength$5(value.length) && !!typedArrayTags$1[baseGetTag$9(value)];
}
 ...
 */
function castFunction$3(value) {
  return typeof value == 'function' ? value : identity$3;
}

var _castFunction$1 = castFunction$3;

var baseForOwn$3 = _baseForOwn$1,
    castFunction$2 = _castFunction$1;
...
function forOwn(object, iteratee) {
  return object && baseForOwn$3(object, castFunction$2(iteratee));
}
...
var Map$3 = getNative$6(root$8, 'Map');
...
/* Built-in method references that are verified to be native. */
var Set$1 = getNative$2(root$4, 'Set');
...
function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray$a(object),
      ...
      objTag = objIsArr ? arrayTag$2 : getTag$3(object),
      othTag = othIsArr ? arrayTag$2 : getTag$3(other);

  objTag = objTag == argsTag$3 ? objectTag$2 : objTag;
  othTag = othTag == argsTag$3 ? objectTag$2 : othTag;
...
function isSymbol$5(value) {
  return typeof value == 'symbol' ||
    (isObjectLike$7(value) && baseGetTag$5(value) == symbolTag$3);
}

var isSymbol_1$1 = isSymbol$5;

var isArray$9 = isArray_1$1,
    isSymbol$4 = isSymbol_1$1;
...
function hasPath$1(object, path, hasFunc) {
  ...
  return !!length && isLength$3(length) && isIndex$2(key, length) &&
    (isArray$6(object) || isArguments$2(object));
}
...
var isArrayLike$5 = isArrayLike_1$1;
...
var _baseEach$1 = baseEach$3;

var baseEach$2 = _baseEach$1,
...
var arrayLikeKeys$2 = _arrayLikeKeys$1,
...
function baseIsMap$1(value) {
  return isObjectLike$6(value) && getTag$2(value) == mapTag$2;
}
...
function baseIsSet$1(value) {
  return isObjectLike$5(value) && getTag$1(value) == setTag$2;
}
  ...
  activeNames.map(function (name) {
    ...
    if (toMerge) {
      (0, _forOwn3$1.default)(toMerge, function (value, key) {
        ...
        styles[key] = _extends$7({}, styles[key], toMerge[key]);
      });
    }
...
var autoprefix = autoprefix$1.autoprefix = function autoprefix(elements) {
  ...
  (0, _forOwn3.default)(elements, function (styles, element) {
    ...
    (0, _forOwn3.default)(styles, function (value, key) {
      ...
      if (transform) {
        expanded = _extends$6({}, expanded, transform(value));
      } else {
        expanded[key] = value;
      }
    });
...
var _react2$a = _interopRequireDefault$c(_react$a);
    ...
    function Hover() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$7(this, (_ref = Hover.__proto__ || Object.getPrototypeOf(Hover)).call.apply(_ref, [this].concat(args))), _this), _this.state = { hover: false }, _this.handleMouseOver = function () {
        ...
        return _react2$a.default.createElement(
          ...
          _react2$a.default.createElement(Component, _extends$5({}, _this.props, _this.state))
        );
...
var _react2$9 = _interopRequireDefault$b(_react$9);
    ...
    function Active() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, (_ref = Active.__proto__ || Object.getPrototypeOf(Active)).call.apply(_ref, [this].concat(args))), _this), _this.state = { active: false }, _this.handleMouseDown = function () {
        ...
        return _react2$9.default.createElement(
          ...
          _react2$9.default.createElement(Component, _extends$4({}, _this.props, _this.state))
        );
...
lib.ReactCSS = lib.loop = lib.handleActive = lib.handleHover = lib.hover = undefined;
...
var _each2 = _interopRequireDefault$9(_each);

var _tinycolor = tinycolor.exports;

var _tinycolor2 = _interopRequireDefault$9(_tinycolor);
...
alpha$1.calculateChange = function calculateChange(e, skip, props, container) {
  e.preventDefault();
...
var render = checkboard$1.render = function render(c1, c2, size, serverCanvas) {
...
checkboard$1.get = function get(c1, c2, size, serverCanvas) {
...
Checkboard$1.Checkboard = undefined;
...
var checkboard = _interopRequireWildcard$3(_checkboard);
...
var Checkboard = Checkboard$1.Checkboard = function Checkboard(_ref) {
  ...
  var styles = (0, _reactcss2$6.default)({
    'default': {
      grid: {
  ...
  return _react2$8.default.createElement('div', { style: styles.grid });
};
...
var alpha = _interopRequireWildcard$2(_alpha);

var _Checkboard = Checkboard$1;

var _Checkboard2 = _interopRequireDefault$7(_Checkboard);
...
var Alpha = Alpha$1.Alpha = function (_ref) {
  ...
  function Alpha() {
    ...
    _classCallCheck$5(this, Alpha);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$5(this, (_ref2 = Alpha.__proto__ || Object.getPrototypeOf(Alpha)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function (e, skip) {
  ...
  _createClass$5(Alpha, [{
    ...
    value: function render() {
      ...
      var styles = (0, _reactcss2$5.default)({
        'default': {
          alpha: {
            absolute: '0px 0px 0px 0px',
      ...
      return _react2$7.default.createElement(
        ...
        _react2$7.default.createElement(
          ...
          _react2$7.default.createElement(_Checkboard2.default, { renderers: this.props.renderers })
        ),
        _react2$7.default.createElement('div', { style: styles.gradient }),
        _react2$7.default.createElement(
          'div',
          {
          ...
          _react2$7.default.createElement(
            ...
            this.props.pointer ? _react2$7.default.createElement(this.props.pointer, this.props) : _react2$7.default.createElement('div', { style: styles.slider })
          )
        )
      );
    }
...
EditableInput$1.EditableInput = undefined;
...
var EditableInput = EditableInput$1.EditableInput = function (_ref) {
  _inherits$4(EditableInput, _ref);

  function EditableInput(props) {
    _classCallCheck$4(this, EditableInput);

    var _this = _possibleConstructorReturn$4(this, (EditableInput.__proto__ || Object.getPrototypeOf(EditableInput)).call(this));
  ...
  _createClass$4(EditableInput, [{
    ...
    value: function render() {
      ...
      var styles = (0, _reactcss2$4.default)({
        'default': {
          wrap: {
            position: 'relative'
          }
      ...
      return _react2$6.default.createElement(
        'div',
        { style: styles.wrap },
        _react2$6.default.createElement('input', {
          style: styles.input,
        ...
        this.props.label && !this.props.hideLabel ? _react2$6.default.createElement(
          'span',
...
hue$1.calculateChange = function calculateChange(e, skip, props, container) {
  e.preventDefault();
  var containerWidth = container.clientWidth;
  var containerHeight = container.clientHeight;
  var x = typeof e.pageX === 'number' ? e.pageX : e.touches[0].pageX;
...
var hue = _interopRequireWildcard$1(_hue);
...
var Hue = Hue$1.Hue = function (_ref) {
  ...
  function Hue() {
    ...
    _classCallCheck$3(this, Hue);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, (_ref2 = Hue.__proto__ || Object.getPrototypeOf(Hue)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function (e, skip) {
  ...
  _createClass$3(Hue, [{
    ...
    value: function render() {
      ...
      var styles = (0, _reactcss2$3.default)({
        'default': {
          hue: {
            absolute: '0px 0px 0px 0px',
            borderRadius: this.props.radius,
      ...
      return _react2$5.default.createElement(
        ...
        _react2$5.default.createElement(
          ...
          _react2$5.default.createElement(
            'div',
            { style: styles.pointer },
            this.props.pointer ? _react2$5.default.createElement(this.props.pointer, this.props) : _react2$5.default.createElement('div', { style: styles.slider })
          )
        )
      );
    }
...
var Raised = Raised$1.Raised = function Raised(_ref) {
  var zDepth = _ref.zDepth,
      radius = _ref.radius,
      background = _ref.background,
      children = _ref.children;

  var styles = (0, _reactcss2$2.default)({
    'default': {
      wrap: {
        position: 'relative',
  ...
  return _react2$4.default.createElement(
    'div',
    { style: styles.wrap },
    _react2$4.default.createElement('div', { style: styles.bg }),
...
saturation$1.calculateChange = function calculateChange(e, skip, props, container) {
  e.preventDefault();
...
Saturation$1.Saturation = undefined;
...
var Saturation = Saturation$1.Saturation = function (_ref) {
  _inherits$2(Saturation, _ref);

  function Saturation(props) {
    _classCallCheck$2(this, Saturation);

    var _this = _possibleConstructorReturn$2(this, (Saturation.__proto__ || Object.getPrototypeOf(Saturation)).call(this, props));
  ...
  _createClass$2(Saturation, [{
    ...
    value: function render() {
      ...
      var styles = (0, _reactcss2$1.default)({
        'default': {
          color: {
            absolute: '0px 0px 0px 0px',
      ...
      return _react2$3.default.createElement(
        ...
        _react2$3.default.createElement(
          ...
          _react2$3.default.createElement('div', { style: styles.black, className: 'saturation-black' }),
          _react2$3.default.createElement(
            'div',
            { style: styles.pointer },
            this.props.pointer ? _react2$3.default.createElement(this.props.pointer, this.props) : _react2$3.default.createElement('div', { style: styles.circle })
          )
        )
      );
    }
...
ColorWrap$1.ColorWrap = undefined;
...
var _color2 = _interopRequireDefault$2(_color);
...
var ColorWrap = ColorWrap$1.ColorWrap = function ColorWrap(Picker) {
  var ColorPicker = function (_ref) {
    _inherits$1(ColorPicker, _ref);

    function ColorPicker(props) {
      _classCallCheck$1(this, ColorPicker);

      var _this = _possibleConstructorReturn$1(this, (ColorPicker.__proto__ || Object.getPrototypeOf(ColorPicker)).call(this));
      ...
      _this.state = _extends$2({}, _color2.default.toState(props.color, 0));
    ...
    _createClass$1(ColorPicker, [{
      key: 'componentWillReceiveProps',
      value: function componentWillReceiveProps(nextProps) {
        this.setState(_extends$2({}, _color2.default.toState(nextProps.color, this.state.oldHue)));
      }
    }, {
      key: 'render',
      value: function render() {
  ...
  ColorPicker.propTypes = _extends$2({}, Picker.propTypes);

  ColorPicker.defaultProps = _extends$2({}, Picker.defaultProps, {
    color: {
      h: 250,
      s: 0.50,
      l: 0.20,
...
interaction.handleFocus = undefined;
    ...
    _createClass(Focus, [{
      ...
      value: function render() {
        return _react2$1.default.createElement(
          ...
          _react2$1.default.createElement(Component, _extends$1({}, this.props, this.state))
        );
      }
    }]);
...
var Swatch = Swatch$1.Swatch = function Swatch(_ref) {
...
export { _root as _, common as a, isObject_1 as b, color as c, _Symbol as d, isArray_1 as e, _baseGetTag as f, isBuffer$1 as g, isTypedArray_1 as h, isFunction_1 as i, isObjectLike_1 as j, keys_1 as k, lib as l, isSymbol_1 as m, isArguments_1 as n, _isIndex as o, isLength_1 as p, identity_1 as q, _baseEach as r, isArrayLike_1 as s };
